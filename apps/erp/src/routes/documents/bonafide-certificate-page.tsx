...
export function BonafideCertificatePage() {
  ...
  return (
    <PrintDocumentShell
      ...
      subtitle={`Certificate No. BF-${studentId?.slice(0, 8).toUpperCase()}`}
      title={DOCUMENT_TITLES.BONAFIDE_CERTIFICATE}
    >
      <div className="space-y-8">
        <p className="text-sm leading-relaxed text-muted-foreground">
          ...
          {student.admissionNumber
            ...
            : ""}{" "}
          is a bonafide student of this institution and is currently enrolled as
          described below.
        </p>
