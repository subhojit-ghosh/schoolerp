...
export const SALARY_COMPONENTS_PAGE_COPY = {
  ...
  DESCRIPTION:
    "Manage earning and deduction components used in salary templates.",
  EMPTY_TITLE: "No salary components yet",
  EMPTY_DESCRIPTION:
    "Create salary components to start building salary templates.",
...
export const SALARY_TEMPLATES_PAGE_COPY = {
  ...
  DESCRIPTION:
    "Define reusable salary structures with earning and deduction components.",
  EMPTY_TITLE: "No salary templates yet",
  EMPTY_DESCRIPTION:
    "Create a salary template to define how salaries are structured.",
