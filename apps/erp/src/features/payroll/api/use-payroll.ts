...
function invalidatePayrollLists(
  ...
  void queryClient.invalidateQueries({
    queryKey: apiQueryClient.queryOptions(
      "get",
      PAYROLL_API_PATHS.LIST_SALARY_COMPONENTS,
      { params: { query: {} } },
    ).queryKey,
  });
  void queryClient.invalidateQueries({
    queryKey: apiQueryClient.queryOptions(
      "get",
      PAYROLL_API_PATHS.LIST_SALARY_TEMPLATES,
      { params: { query: {} } },
    ).queryKey,
  });
  void queryClient.invalidateQueries({
    queryKey: apiQueryClient.queryOptions(
      "get",
      PAYROLL_API_PATHS.LIST_SALARY_ASSIGNMENTS,
      { params: { query: {} } },
    ).queryKey,
  });
  void queryClient.invalidateQueries({
    queryKey: apiQueryClient.queryOptions(
      "get",
      PAYROLL_API_PATHS.LIST_PAYROLL_RUNS,
      { params: { query: {} } },
    ).queryKey,
  });
}
...
// Salary Components
export function useSalaryComponentsQuery(
  enabled: boolean,
...
export function useCreateSalaryComponentMutation() {
  ...
  return apiQueryClient.useMutation(
    "post",
    PAYROLL_API_PATHS.CREATE_SALARY_COMPONENT,
    {
      onSuccess: () => {
...
export function useUpdateSalaryComponentMutation() {
  ...
  return apiQueryClient.useMutation(
    "patch",
    PAYROLL_API_PATHS.UPDATE_SALARY_COMPONENT,
    {
      onSuccess: () => {
        invalidatePayrollLists(queryClient);
      },
...
export function useUpdateSalaryComponentStatusMutation() {
  ...
  return apiQueryClient.useMutation(
    "patch",
    PAYROLL_API_PATHS.UPDATE_SALARY_COMPONENT_STATUS,
    {
      onSuccess: () => {
        invalidatePayrollLists(queryClient);
      },
...
export function useSalaryTemplateDetailQuery(
  enabled: boolean,
  templateId?: string,
) {
  return apiQueryClient.useQuery(
...
export function useCreateSalaryTemplateMutation() {
  ...
  return apiQueryClient.useMutation(
    "post",
    PAYROLL_API_PATHS.CREATE_SALARY_TEMPLATE,
    {
      onSuccess: () => {
        invalidatePayrollLists(queryClient);
      },
...
export function useUpdateSalaryTemplateMutation() {
  ...
  return apiQueryClient.useMutation(
    "patch",
    PAYROLL_API_PATHS.UPDATE_SALARY_TEMPLATE,
    {
      onSuccess: () => {
        invalidatePayrollLists(queryClient);
      },
...
export function useUpdateSalaryTemplateStatusMutation() {
  ...
  return apiQueryClient.useMutation(
    "patch",
    PAYROLL_API_PATHS.UPDATE_SALARY_TEMPLATE_STATUS,
    {
      onSuccess: () => {
        invalidatePayrollLists(queryClient);
      },
...
// Salary Assignments
export function useSalaryAssignmentsQuery(
  enabled: boolean,
  query: Record<string, unknown> = {},
) {
  return apiQueryClient.useQuery(
...
export function useSalaryAssignmentDetailQuery(
  enabled: boolean,
  assignmentId?: string,
) {
  return apiQueryClient.useQuery(
...
export function useCreateSalaryAssignmentMutation() {
  ...
  return apiQueryClient.useMutation(
    "post",
    PAYROLL_API_PATHS.CREATE_SALARY_ASSIGNMENT,
    {
      onSuccess: () => {
        invalidatePayrollLists(queryClient);
      },
...
export function useUpdateSalaryAssignmentMutation() {
  ...
  return apiQueryClient.useMutation(
    "patch",
    PAYROLL_API_PATHS.UPDATE_SALARY_ASSIGNMENT,
    {
      onSuccess: () => {
        invalidatePayrollLists(queryClient);
      },
...
export function useUpdateSalaryAssignmentStatusMutation() {
  ...
  return apiQueryClient.useMutation(
    "patch",
    PAYROLL_API_PATHS.UPDATE_SALARY_ASSIGNMENT_STATUS,
    {
      onSuccess: () => {
        invalidatePayrollLists(queryClient);
      },
...
export function useCreatePayrollRunMutation() {
  ...
  return apiQueryClient.useMutation(
    "post",
    PAYROLL_API_PATHS.CREATE_PAYROLL_RUN,
    {
      onSuccess: () => {
        invalidatePayrollLists(queryClient);
      },
...
export function useProcessPayrollRunMutation() {
  ...
  return apiQueryClient.useMutation(
    "post",
    PAYROLL_API_PATHS.PROCESS_PAYROLL_RUN,
    {
      onSuccess: () => {
        invalidatePayrollLists(queryClient);
      },
...
export function useApprovePayrollRunMutation() {
  ...
  return apiQueryClient.useMutation(
    "post",
    PAYROLL_API_PATHS.APPROVE_PAYROLL_RUN,
    {
      onSuccess: () => {
        invalidatePayrollLists(queryClient);
      },
...
export function useMarkPaidPayrollRunMutation() {
  ...
  return apiQueryClient.useMutation(
    "post",
    PAYROLL_API_PATHS.MARK_PAID_PAYROLL_RUN,
    {
      onSuccess: () => {
        invalidatePayrollLists(queryClient);
      },
