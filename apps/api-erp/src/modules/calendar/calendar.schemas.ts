...
export type SetCalendarEventStatusDto = z.infer<typeof setCalendarEventStatusSchema>;

type ListCalendarEventsQueryInput = z.infer<typeof listCalendarEventsQuerySchema>;
export type ListCalendarEventsQueryDto = Omit<ListCalendarEventsQueryInput, "q"> & {
  search?: string;
};
...
export function parseCreateCalendarEvent(body: unknown): CreateCalendarEventDto {
  return parseSchema(createCalendarEventSchema, body);
}

export function parseUpdateCalendarEvent(body: unknown): UpdateCalendarEventDto {
