...
- **Do not run `bun run typecheck` unless the user explicitly asks for it in the current conversation.** Do not treat it as a default finishing step.
- **Do not run Playwright tests, browser automation, or visual verification unless the user explicitly asks for it in the current conversation.**
